...
|---------|---------|-------|-------------|-------|------------|
| v37 | — | 2026-07-11 | Botón ⏱ en Notas: registro de tiempos en llamada — se escribe el tiempo, Enter lo guarda con fecha/hora automáticas, 🗑 por entrada; persiste en localStorage (`interprete_tiempos`), separado de las notas libres. Solo frontend. | ⏳ | Recargar la pestaña de Brave (F5) para verlo. |
